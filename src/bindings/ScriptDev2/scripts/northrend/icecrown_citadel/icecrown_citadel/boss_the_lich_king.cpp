...
struct MANGOS_DLL_DECL boss_lich_king_iccAI : public ScriptedAI
{
    boss_lich_king_iccAI(Creature* pCreature) : ScriptedAI(pCreature)
    {
...
CreatureAI* GetAI_boss_lich_king_icc(Creature* pCreature)
{
    return new boss_lich_king_iccAI(pCreature);
}
...
void AddSC_boss_lich_king_icc()
{
    ...
    pNewScript->GetAI = &GetAI_boss_lich_king_icc;
