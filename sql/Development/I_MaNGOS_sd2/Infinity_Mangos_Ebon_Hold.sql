...
-- Remove sd2 name setting from death charger
...
UPDATE `creature_template` SET `minhealth` = 1910, `maxhealth` = 1910 WHERE `entry` = 28942;
...
UPDATE `creature` SET `curhealth` = 1910 WHERE `id` = 28942;
