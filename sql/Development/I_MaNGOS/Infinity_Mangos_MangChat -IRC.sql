...
UPDATE `mangos_string` SET `content_default` = 'All tickets closed.' WHERE entry = 294;
UPDATE `mangos_string` SET `content_default` = 'Character %s ticket closed.' WHERE entry = 295;
UPDATE `mangos_string` SET `content_default` = 'Ticket closed.' WHERE entry = 296;
