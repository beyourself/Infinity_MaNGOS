...
DELETE FROM `anticheat_config`;
/*!40000 ALTER TABLE `anticheat_config` DISABLE KEYS */;
INSERT INTO `anticheat_config` (`checktype`, `description`, `check_period`, `alarmscount`, `disableoperation`, `messagenum`, `intparam1`, `intparam2`, `floatparam1`, `floatparam2`, `action1`, `actionparam1`, `action2`, `actionparam2`, `disabledzones`) VALUES
