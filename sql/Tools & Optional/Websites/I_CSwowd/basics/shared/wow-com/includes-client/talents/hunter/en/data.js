...
rank[i] = [
"Reduces the mana cost of your Mend Pet spell by 10% and gives the Mend Pet spell a 15% chance of cleansing 1 Curse, Disease, Magic or Poison effect from the pet each tick.",
...
rank[i] = [
"Increases your pet's chance to dodge by 3% and your chance to dodge by 1%.",
"Increases your pet's chance to dodge by 6% and your chance to dodge by 2%.",
"Increases your pet's chance to dodge by 9% and your chance to dodge by 3%."
                ];
i++;
...
rank[i] = [
"Causes 20% of your Hunter's Mark ability effect to apply to melee attack power as well.",
"Causes 40% of your Hunter's Mark ability effect to apply to melee attack power as well.",
"Causes 60% of your Hunter's Mark ability effect to apply to melee attack power as well.",
"Causes 80% of your Hunter's Mark ability effect to apply to melee attack power as well.",
...
rank[i] = [
                "<span style=text-align:left;float:left;>75 Mana</span><span style=text-align:right;float:right;>8-35 yd range</span><br><span style=text-align:left;float:left;>3.5 sec cast</span><span style=text-align:left;float:left;>6 sec cooldown + Ranged Weapon Speed</span><br><br>Requires Ranged Weapon<br>An aimed shot that increases ranged damage by 870.<br><br>\
...
8-35 yd range</span><br><span style=text-align:left;float:left;>\
