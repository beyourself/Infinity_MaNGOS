...
<table cellspacing = "0" cellpadding = "0" border = "0" width = "100%" style="background: url('/shared/wow-com/images/basics/factions/argent/banner/background.jpg');">
  <tr>
          <td>
                  <div id="wrapper99">
                        <div id = "icon">
                                <img src="/shared/wow-com/images/basics/factions/argent/banner/icon.gif" title="Hi ho, hi ho, it's off to work I go.">
                        </div>
                </div>
          </td>
          <td>
                  <div id = "wrapper">
                        <div id = "text">
                                <img src="/shared/wow-com/images/basics/factions/argent/banner/en/header-text.gif">
                        </div>
                </div>
          </td>
...
<tr>
    ...
    <td width = "362" background = "../../../../../shared/wow-com/images/headers/tabheader/tabheader-left.jpg" align = "left" NOWRAP><h3 class = "guideTitle">The Argent Dawn</h3></td>
