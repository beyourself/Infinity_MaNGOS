...
<td width = "362" background = "../../../../shared/wow-com/images/headers/tabheader/tabheader-left.jpg" align = "left" NOWRAP><h3 class = "guideTitle">Arathi Basin Score Screen</h3></td>
...
<B>Rank Icon</B><BR>
This icon shows the player-vs.-player Honor Rank of that character. Click <a href="../ranks.php">here</a> to see a list of ranks for both Horde and Alliance.
<P>
<B>Name</B><BR>
This lists all the players currently participating in that Battleground instance. Alliance players' names are listed in blue, and Horde players' names are listed in red. Your name is listed as yellow.
<P>
...
This lists the number of enemies that a player, or his/her group, participated in defeating in that Battleground.
<P>
<B>Bases Assaulted</B><BR>
This lists the number of times the player successfully captured an enemy controlled resource node.
<P>
<B>Bases Defended</B><BR>
This lists the number of times the player successfully converted a resource node banner that has been turned neutral by the opposing faction.
<P>
<B>Bonus Honor</B><BR>
This lists the amount of bonus Honor awarded to each team. Bonus Honor is awarded to each team every time they capture the opposing team's flag.
<P>
</ul>
<br><br>
