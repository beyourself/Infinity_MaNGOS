...
<script SRC="<? echo $Offset ?>../shared/wow-com/includes-client/detection.js" language="JavaScript"></script><script language="javascript">
        //
        if (is_ie)
        ...
        //
        </script><script SRC="<? echo $Offset ?>new-hp/js/functions.js" type="text/javascript"></script><script SRC="<? echo $Offset ?>new-hp/js/p7_eqCols2_10.js" type="text/javascript"></script>
  </head>
  <body>
    <div style="background: url(<? echo $Offset ?>new-hp/images/page-bg-top.jpg) repeat-x 0 0; height: 88px; position: relative; width: 100%;"></div>
    <center>
      <table border="0" cellpadding="0" cellspacing="0" width="985">
        <tr>
          <td width="955">
            <div id="hp">
              <div style="z-index: 1001; position: relative; width: 955px;">
                <a HREF="<? echo $Offset.$lang['TopLink1']; ?>"><img title="Account Management" alt="account-management" style="position: absolute; top: 5px; right: 280px;" height="31" width="143" SRC="<? echo $Offset ?>new-hp/images/pixel.gif"></a><a HREF="<? echo $Offset.$lang['TopLink2']; ?>"><img title="Realm Status" alt="realm-status" style="position: absolute; top: 5; right: 127;" height="31" width="153" SRC="<? echo $Offset ?>new-hp/images/pixel.gif"></a><a HREF="<? echo $Offset.$lang['TopLink3']; ?>"><img title="Sign up!" alt="sign-up" style="position: absolute; top: 5px; right: 10px;" height="31" width="153" SRC="<? echo $Offset ?>new-hp/images/pixel.gif"></a>
              </div>
              <div style="position:relative; z-index:0;">
                <div class="top-nav">
                  <img style="margin-right: -3px;" alt="metal-left" height="31" width="44" SRC="<? echo $Offset ?>new-hp/images/metal-left.gif"><a HREF="<? echo $Offset.$lang['TopLink1']; ?>"><img title="Account Management" alt="account-management" height="31" width="143" SRC="<? echo $Offset ?>new-hp/images/account-management.gif"></a><a HREF="<? echo $Offset.$lang['TopLink2']; ?>"><img title="Realm Status" alt="realm-status" height="31" width="153" SRC="<? echo $Offset ?>new-hp/images/realm-status.gif"></a><a href="<? echo $Offset.$lang['TopLink3']; ?>"><img title="Sign up!" alt="signup" height="31" width="117" SRC="<? echo $Offset ?>new-hp/images/signup.gif"></a>
                </div>
              </div>
              <div class="top-nav-container">
                <div style="position: absolute; right: 232px; top: 39px; z-index:999999">
                  <div style="z-index:999999999;" id="countryDropDown"></div>
                </div>
                <div style="position: absolute; top: 0; left: 0; z-index: 20002;">
                  <div id="wow-logo">
                    <a HREF="#"><img title="World of Warcraft" alt="wowlogo" height="94" width="184" SRC="<? echo $Offset ?>new-hp/images/pixel.gif"></a>
                  </div>
                </div>
              </div>
              <div>
...
<link rel="stylesheet" type="text/css" href="http://www.start.no/home/error/404" media="screen, projection" />
    <META http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    <title><? echo($lang['sitename']); ?></title>
...
if(ereg("msie", $br))
{
  ?> @import "<? echo $Offset ?>new-hp/css/loader_screen.css"; <?
}
else
{
   ?> @import "<? echo $Offset ?>new-hp/css/other_loader_screen.css"; <?
}
         ?>

    </style>
    <link title="orc" href="<? echo $Offset ?>new-hp/css/orc.css" media="screen, projection" type="text/css" rel="alternate stylesheet">
    <script SRC="<? echo $Offset ?>../shared/wow-com/includes-client/detection.js" language="JavaScript"></script><script language="javascript">
  ...
  <body style="background-image: url('<? echo $Offset ?>../shared/wow-com/includes-client/new-hp/images/page-bg-alt3.jpg')">
                                <? if($lang['menu1'] == 'ON') { ?><div id="menuNews">
                                  <div onclick="javascript:toggleNewMenu(1-1);" class="menu-button-off" id="menuNews-button">
                                    <span class="menuNews-icon-off" id="menuNews-icon">
                                                                        &nbsp;</span><a class="menuNews-header-off" id="menuNews-header"><em>Gaame
                                                                        Guide</em></a><a id="menuNews-collapse"></a><span class="menuEntry-rightBorder"></span>
                                  </div>
                                            ...
                                            <ul class="mainNav">
                                              <div style="position:relative;" id="menuFiller1">
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" href="<? echo $Offset.$lang['menu1link1']; ?>">
                                                                                                        <? echo $lang['menu1label1'] ?></a>
                                                </div>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu1link2']; ?>">
                                ...
                                <div id="menuAccount">
                                  <div onclick="javascript:toggleNewMenu(2-1);" class="menu-button-off" id="menuAccount-button">
                                    <span class="menuAccount-icon-off" id="menuAccount-icon">
                                                                        &nbsp;</span><a class="menuAccount-header-off" id="menuAccount-header"><em>Game
                                                                        Guide</em></a><a id="menuAccount-collapse"></a><span class="menuEntry-rightBorder"></span>
                                  </div>
                                              ...
                                              <div style="position:relative;" id="menuFiller2">
                                               <? if($lang[menu2label1] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  ...
                                                  <a class="menuFiller" href="<? echo $Offset.$lang['menu2link1']; ?>">
                                                ...
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  ...
                                                  <a class="menuFiller" href="<? echo $Offset.$lang['menu2link2']; ?>">
                                                ...
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  ...
                                                  <a class="menuFiller" href="<? echo $Offset.$lang['menu2link3']; ?>">
                                                ...
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  ...
                                                  <a class="menuFiller" href="<? echo $Offset.$lang['menu2link4']; ?>">
                                ...
                                <div id="menuGameGuide">
                                  <div onclick="javascript:toggleNewMenu(3-1);" class="menu-button-off" id="menuGameGuide-button">
                                    <span class="menuGameGuide-icon-off" id="menuGameGuide-icon">
                                                                        &nbsp;</span><a class="menuGameGuide-header-off" id="menuGameGuide-header"><em>Game
                                                                        Guide</em></a><a id="menuGameGuide-collapse"></a><span class="menuEntry-rightBorder"></span>
                                  </div>
                                        ...
                                        <div class="m-right">
                                          <div class="leftMenu-cnt">
                                            <ul class="mainNav">
                                              ...
                                              <? if($lang[menu3label1] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" href="<? echo $Offset.$lang['menu3link1']; ?>"><? echo $lang['menu3label1']; ?></a> </div>
                                                <? } ?>
                                                <? if($lang[menu3label2] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-indent-bg.gif'); width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  &nbsp;&nbsp;<a class="menuFiller" href="<? echo $Offset.$lang['menu3link2']; ?>"><? echo $lang['menu3label2']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu3label3] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-indent-bg.gif'); width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                   &nbsp;&nbsp;<a class="menuFiller" HREF="<? echo $Offset.$lang['menu3link3']; ?>"><? echo $lang['menu3label3']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu3label4] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-indent-bg.gif'); width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                   &nbsp;&nbsp;<a class="menuFiller" href="<? echo $Offset.$lang['menu3link4']; ?>"><? echo $lang['menu3label4']; ?></a>&nbsp;
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu3label5] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu3link5']; ?>">
                                ...
                                <div id="menuInteractive">
                                  <div onclick="javascript:toggleNewMenu(4-1);" class="menu-button-off" id="menuInteractive-button">
                                    <span class="menuInteractive-icon-off" id="menuInteractive-icon">
                                                                        &nbsp;</span><a class="menuInteractive-header-off" id="menuInteractive-header"><em>Game
                                                                        Guide</em></a><a id="menuInteractive-collapse"></a><span class="menuEntry-rightBorder"></span>
                                  </div>
                                        ...
                                        <div class="m-right">
                                          <div class="leftMenu-cnt">
                                            <ul class="mainNav">
                                              ...
                                              <? if($lang[menu4label1] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu4link1']; ?>">
                                                                                                        <? echo $lang['menu4label1']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu4label2] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu4link2']; ?>">
                                                                                                         <? echo $lang['menu4label2']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu4label3] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu4link3']; ?>">
                                                                                                         <? echo $lang['menu4label3']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu4label4] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu4link4']; ?>">
                                                                                                         <? echo $lang['menu4label4']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu4label5] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu4link5']; ?>">
                                                                                                         <? echo $lang['menu4label5']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu4label6] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu4link6']; ?>">
                                                                                                         <? echo $lang['menu4label6']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu4label7] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu4link7']; ?>">
                                                                                                         <? echo $lang['menu4label7']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu4label8] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu4link8']; ?>">
                                ...
                                <div id="menuMedia">
                                  <div onclick="javascript:toggleNewMenu(5-1);" class="menu-button-off" id="menuMedia-button">
                                    <span class="menuMedia-icon-off" id="menuMedia-icon">
                                                                        &nbsp;</span><a class="menuMedia-header-off" id="menuMedia-header"><em>Game
                                                                        Guide</em></a><a id="menuMedia-collapse"></a><span class="menuEntry-rightBorder"></span>
                                  </div>
                                        ...
                                        <div class="m-right">
                                          <div class="leftMenu-cnt">
                                            <ul class="mainNav">
                                                ...
                                                <? if($lang[menu5label1] <> '') { ?>
                                                                                                        <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                                                                                <a class="menuFiller" href="<? echo $Offset.$lang['menu5link1']; ?>"><? echo $lang['menu5label1']; ?></a>
                                                                                                        </div>
                                                                                                         <? } ?>
                                                <? if($lang[menu5label2] <> '') { ?>
                                                                                                        <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                                                                                <a class="menuFiller" HREF="<? echo $Offset.$lang['menu5link2']; ?>"><? echo $lang['menu5label2']; ?></a>
                                                                                                        </div>
                                                                                                         <? } ?>
                                                <? if($lang[menu5label3] <> '') { ?>
                                                                                                        <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                                                                                <a class="menuFiller" HREF="<? echo $Offset.$lang['menu5link3']; ?>"><? echo $lang['menu5label3']; ?></a>
                                                                                                        </div>
                                                                                                         <? } ?>
                                                <? if($lang[menu5label4] <> '') { ?>
                                                                                                        <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                                                                                <a class="menuFiller" HREF="<? echo $Offset.$lang['menu5link4']; ?>"><? echo $lang['menu5label4']; ?></a>
                                                                                                        </div>
                                                                                                         <? } ?>
                                                <? if($lang[menu5label5] <> '') { ?>
                                                                                                        <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                                                                                <a class="menuFiller" HREF="<? echo $Offset.$lang['menu5link5']; ?>"><? echo $lang['menu5label5']; ?></a>
                                                                                                        </div>
                                                                                                         <? } ?>
                                                <? if($lang[menu5label6] <> '') { ?>
                                                                                                        <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                                                                                <a class="menuFiller" HREF="<? echo $Offset.$lang['menu5link6']; ?>"><? echo $lang['menu5label6']; ?></a>
                                                                                                        </div>
                                                                                                         <? } ?>
                                                <? if($lang[menu5label7] <> '') { ?>
                                                                                                        <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                                                                                <a class="menuFiller" HREF="<? echo $Offset.$lang['menu5link7']; ?>"><? echo $lang['menu5label7']; ?></a>
                                                                                                        </div>
                                                                                                         <? } ?>
                                ...
                                <div id="menuForums">
                                  <div onclick="javascript:toggleNewMenu(6-1);" class="menu-button-off" id="menuForums-button">
                                    <span class="menuForums-icon-off" id="menuForums-icon">
                                                                        &nbsp;</span><a class="menuForums-header-off" id="menuForums-header"><em>Game
                                                                        Guide</em></a><a id="menuForums-collapse"></a><span class="menuEntry-rightBorder"></span>
                                  </div>
                                        ...
                                        <div class="m-right">
                                          <div class="leftMenu-cnt">
                                            <ul class="mainNav">
                                              ...
                                              <? if($lang[menu6label1] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang[menu6link1]; ?>">
                                                                                                        <? echo $lang[menu6label1]; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu6label2] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang[menu6link2]; ?>">
                                                                                                        <? echo $lang[menu6label2]; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu6label3] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang[menu6link3]; ?>">
                                                                                                        <? echo $lang[menu6label3]; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu6label4] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang[menu6link4]; ?>">
                                                                                                        <? echo $lang[menu6label4]; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu6label5] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang[menu6link5]; ?>">
                                                                                                        <? echo $lang[menu6label5]; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu6label6] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang[menu6link6]; ?>">
                                ...
                                <div id="menuCommunity">
                                  <div onclick="javascript:toggleNewMenu(7-1);" class="menu-button-off" id="menuCommunity-button">
                                    <span class="menuCommunity-icon-off" id="menuCommunity-icon">
                                                                        &nbsp;</span><a class="menuCommunity-header-off" id="menuCommunity-header"><em>Game
                                                                        Guide</em></a><a id="menuCommunity-collapse"></a><span class="menuEntry-rightBorder"></span>
                                  </div>
                                          ...
                                          <div class="leftMenu-cnt">
                                            <ul class="mainNav">
                                              <div style="position:relative;" id="menuFiller7">
                                                ...
                                                <? if($lang[menu7label1] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu7link1']; ?>">
                                                                                                        <? echo $lang['menu7label1']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu7label2] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu7link2']; ?>">
                                                                                                        <? echo $lang['menu7label2']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu7label3] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu7link3']; ?>">
                                                                                                        <? echo $lang['menu7label3']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu7label4] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu7link4']; ?>">
                                                                                                        <? echo $lang['menu7label4']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu7label5] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu7link5']; ?>">
                                                                                                        <? echo $lang['menu7label5']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu7label6] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu7link6']; ?>">
                                                                                                        <? echo $lang['menu7label6']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu7label7] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu7link7']; ?>">
                                                                                                        <? echo $lang['menu7label7']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu7label8] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu7link8']; ?>">
                                ...
                                <div id="menuSupport">
                                  <div onclick="javascript:toggleNewMenu(8-1);" class="menu-button-off" id="menuSupport-button">
                                    <span class="menuSupport-icon-off" id="menuSupport-icon">
                                                                        &nbsp;</span><a class="menuSupport-header-off" id="menuSupport-header"><em>Game
                                                                        Guide</em></a><a id="menuSupport-collapse"></a><span class="menuEntry-rightBorder"></span>
                                  </div>
                                          ...
                                          <div class="leftMenu-cnt">
                                            <ul class="mainNav">
                                              <div style="position:relative;" id="menuFiller8">
                                                ...
                                                <? if($lang[menu8label1] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu8link1']; ?>">
                                                                                                        <? echo $lang['menu8label1']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu8label2] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu8link2']; ?>">
                                                                                                        <? echo $lang['menu8label2']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu8label3] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu8link3']; ?>">
                                                                                                        <? echo $lang['menu8label3']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu8label4] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu8link4']; ?>">
                                                                                                        <? echo $lang['menu8label4']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu8label5] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu8link5']; ?>">
                                                                                                        <? echo $lang['menu8label5']; ?></a>
                                                </div>
                                                <? } ?>
                                                <? if($lang[menu8label6] <> '') { ?>
                                                <div style="font-weight:bold; text-decoration: none; font-family:arial,comic sans ms,technical; font-size: 11px; position: relative; left: -3px; background-image:url('new-hp/images/menu/mainmenu/bullet-trans-bg.gif');        width:139px; height:15px; _height:18px; padding:0px; margin:0px; _margin-bottom:-3px; border:0px; padding-left:10px;">
                                                  <a class="menuFiller" HREF="<? echo $Offset.$lang['menu8link6']; ?>">
...
<!-- Mirrored from home.no.net/dzwt2/index.php by HTTrack Website Copier/3.x [XR&CO'2006], Fri, 01 Sep 2006 18:54:04 GMT -->
</html>                        </div>
                      </td><td valign="top">
                        <div id="mainWrapper">
                          <div id="main">
