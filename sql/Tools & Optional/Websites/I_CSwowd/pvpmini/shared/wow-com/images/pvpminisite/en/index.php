...
<tr>
        ...
        <td background = "../../../../../shared/wow-com/images/headers/dateheader/dateheader-bg.gif" width = "100%"><h3 class = "titleLight">PvP mini site</h3></td>
...
<tr>
    ...
    <td width = "362" background = "../../../../../shared/wow-com/images/headers/tabheader/tabheader-left.jpg" align = "left" NOWRAP><h3 class = "guideTitle">PvP mini site</h3></td>
...
<div class = "postBody">
        ...
        <table cellspacing =" 2" cellpadding =" 3" border =" 0" width =" 100%" height="">
                <tr background="img/light.jpg">
                        <td class="blogbody">


                                <object width="900" height="600">
                                <param name="intro" value="intro.swf">
                                <embed src="intro.swf" width="900" height="600"></embed>
                                </object>
                        </td>
                <tr>
        </table>
...
<!-- Mirrored from www.wow-europe.com/en/info/underdev/ by HTTrack Website Copier/3.x [XR&CO'2006], Sat, 02 Sep 2006 09:08:10 GMT -->
